	...
	<?php while ( have_posts() ) : the_post(); ?>
		<div class="blog-container">
			<div class="title-wrapper">
				...
				<div class="date-and-author col-lg-6">
				...
				<!--
				<div id="share-blog" class="col-lg-6">
					<a class="facebook" href="https://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>">Facebook</a>
					<a class="twitter" href="https://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>">Twitter</a>
				</div>
				-->
...
<!---
<section id="share-blog" class="row">
	<div class="blog-container">
		<a class="facebook" href="https://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>">Facebook</a>
		<a class="twitter" href="https://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>">Twitter</a>
	</div>
