        ...
        <div class="tab-content-container row">
            ...
            <div data-tab="1" id="tab-1" class="tab-content row show">
                <div id="item-page" class="image-wrapper mgB64">
                    ...
                    <img class="" src="<?php echo get_stylesheet_directory_uri(); ?>/img/product-page.svg" alt="">
                    ...
                    <ul class="reco-row">
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-1.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-2.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-3.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-4.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
            ...
            <div data-tab="2" id="tab-2" class="tab-content row">
                <div id="cart-page" class="image-wrapper mgB64">
                    ...
                    <img class="" src="<?php echo get_stylesheet_directory_uri(); ?>/img/cart-page.svg" alt="">
                    ...
                    <ul class="reco-row">
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-20.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-21.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-22.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-23.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
            ...
            <div data-tab="3" id="tab-3" class="tab-content row">
                <div id="home-page" class="image-wrapper mgB64">
                    ...
                    <img class="" src="<?php echo get_stylesheet_directory_uri(); ?>/img/home.svg" alt="">
                    ...
                    <ul class="reco-row">
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-24.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-25.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-26.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-27.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
            ...
            <div data-tab="4" id="tab-4" class="tab-content row">
                <div id="catergory-page" class="image-wrapper mgB64">
                    ...
                    <img class="" src="<?php echo get_stylesheet_directory_uri(); ?>/img/browser.svg" alt="">
                    ...
                    <ul class="reco-row">
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-28.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-29.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-30.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                        ...
                        <li class="product">
                            <div class="product-wrapper">
                                <div class="image col">
                                    <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/item-31.svg" alt="">
                                </div>
                                <div class="content">
                                    <h2>Product Title</h2>
                                    <p>price</p>
                    ...
                    <img class="mgT56" src="<?php echo get_stylesheet_directory_uri(); ?>/img/category-page.svg" alt="">
                </div>
            </div>
            ...
            <div data-tab="5" id="tab-5" class="tab-content row">
                <div id="download-white-paper">
                    <div class="white-paper-cover col-sm-12 col-lg-6">
                        <img class="col" src="<?php echo get_stylesheet_directory_uri(); ?>/img/18-recommendation-types-whitepaper_cover.jpg" alt="">
                    </div>
...
<!--             --><?php //echo do_shortcode('[mc4wp_form id="2318"]') ?>
