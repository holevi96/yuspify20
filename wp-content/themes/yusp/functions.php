...
register_nav_menus(
    array(
        ...
        'sme-mobile' => esc_attr__('sme-mobile'),
...
//    wp_enqueue_script('filter-case-studies', get_template_directory_uri() . '/js/filter-case-studies.js', array('jquery'), false, false);
   if( get_post_type( $post ) === "solution" && is_singular()){
    ...
    if( get_post_type( $post ) === "blog" && is_archive()){
	...
	wp_enqueue_script( 'yusp.min.js', get_stylesheet_directory_uri() . '/dist/yusp.min.js', array( 'jquery' ), false, true );
...
function prefix_ajax_add_foobar() {
	...
	$the_query = new WP_Query( array(
                ...
                <?php  endwhile; ?>
				<div class="row">
				<button page="<?php echo $paged+1; ?>"  class='more-blogs'>More blogs...</button>
				</div>
...
wp_register_script('yusp.min.js', get_stylesheet_directory_uri() . '/dist/yusp.min.js', array('jquery'),'1.1', true);
